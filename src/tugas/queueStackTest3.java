            ...
            System.out.println("\n*** Kelola Data Makanan ***");
                ...
                if(langkah == 1){
                        ...
                        if(queue.size() >= size){
                            ...
                            System.out.println("Data antrian saat ini: " + queue);
                            System.out.print("Masukkan data makanan: ");
                            data = input.next();
                            queue.offer(data);
            ...
            langkah = input.nextInt();
                ...
                if (langkah == 1){
                    if(stack.size() >= size){
                        ...
                        System.out.println("Data tumpukan saat ini: " + stack);
                        System.out.print("Masukkan data pakaian: " );
                        data = input.next();
                        stack.push(data);
