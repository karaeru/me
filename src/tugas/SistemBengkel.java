...
public class SistemBengkel {
    public static void main(String[] args) {
        ...
        String[] daftarServis = {"Servis Ringan Karbu","Servis Ringan Injeksi",
            "Servis Lengkap", "Ganti Oli Mesin", "Ganti Oli Gardan/Samping"};
        double[] biayaServis = {60000, 75000, 200000, 40000, 15000};
